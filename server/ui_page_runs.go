...
func runsPlaceholderHandler(w http.ResponseWriter, r *http.Request) {
	...
	if trimmed == "" || trimmed == "/" {
		...
		b.WriteString("if(!runs.length&&currentOffset===0){el.innerHTML='<p class=\"empty\">No runs yet.</p>';pageInfo.textContent='';prevBtn.disabled=true;nextBtn.disabled=true;return;}")
